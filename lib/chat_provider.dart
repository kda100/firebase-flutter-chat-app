...
class ChatProvider {
  ...
  StreamController<Map<String, ChatContentItem>>
      _chatContentItemsMapStreamController = StreamController<
          Map<String,
              ChatContentItem>>(); //controls when chat screen needs to update.

  ///used in stream builder in chat screen
  Stream<Map<String, ChatContentItem>> get getChatContentItemMapStream =>
      _chatContentItemsMapStreamController.stream;

  Map<String, ChatContentItem> get getChatContentItemMap {
