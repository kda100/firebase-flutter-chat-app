...
class ChatProvider with ChangeNotifier {
  final CollectionReference _chatContentItemCollection =
      FirebaseFirestore.instance.collection("Your chat Collection Reference");
  final Reference _chatsImageStorageRef =
      FirebaseStorage.instance.ref("Your Images Storage Reference");
  final Reference _chatsVideoStorageRef =
      FirebaseStorage.instance.ref("Your Videos Storage Reference");
  final String _myName = "Your Name";
