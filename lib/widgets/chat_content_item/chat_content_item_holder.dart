        ...
        children: [
          ...
          GestureDetector(
            ...
            onTap: (chatContentItem.chatContentItemType ==
                    ...
                    (chatContentItem.runtimeType == UploadChatContentItem &&
                        chatContentItem
                            .isSending)) //can not navigate when image or video is being uploaded.
                ? null
                : () async {
            ...
            children: [
              ...
              if (chatContentItem.runtimeType == CloudChatContentItem &&
                  ...
                  chatContentItem.onCloud !=
                      null) //read receipts and instance of upload checks are only displayed if messages sent by user.
                Icon(
                  chatContentItem.onCloud
