...
class ChatRepository {
  ...
  StreamController<Map<String, ChatContentItem>>
      _chatContentItemsMapStreamController =
      StreamController<Map<String, ChatContentItem>>();
  ...
  Future<void> _deleteChatMediaItemCache({required String id}) async {
    ...
    if (chatContentItemType != null)
      _fileServices.deleteChatMediaItemCache(
          content: content, chatContentItemType: chatContentItemType);
  }
